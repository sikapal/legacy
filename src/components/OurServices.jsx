...
const OurServices = () => {
    ...
    const services = [
        ...
        { id: 4, Title: "NEXT TELEPHONY SYSTEM", description: "Our software are personnalised for you to have a better experience", image: service1 },
        { id: 5, Title: "ENTERPRISE NETWORK", description: "We deploy your Local Network with the necesary security mesures", image: service2 },
        { id: 6, Title: "DIGITAL TRANSFORMTION", description: "We develop  web and mobile applications using the latest technologies", image: service3 }
    ]
    return (
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-12' id='service'>
            <div className='text-center md:w-1/2 mx-auto'>
                ...
                <motion.p
                    ...
                    Notre plan d'action va lorem ipsum dolor.​ Notre plan d'action va lorem ipsum dolor Notre plan d'action va lorem ipsum dolor
                </motion.p>
            </div>
